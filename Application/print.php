...
<img src="../images/susanlogo.png" width="100" height="100" style="float:left;"><strong>Susan Ice Online Ordering System</strong><br>Manlunas Villamor Airbase Pasay City<br>Email Us: susana_potian@yahoo.com<br>Contact: <a href="#">(1800)777-111</a> and call on <a href="#">(+6343)3005704</a>
<br><br><br><br>
<?php
include('connect.php');
		$id=$_GET['id'];
